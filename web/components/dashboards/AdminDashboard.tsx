  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      {(stats?.pendingApplications || 0) > 0 && (
        <div className="mb-8 bg-warning/10 border-2 border-warning rounded-2xl p-6">
        ...
        {statCards.map((stat) => {
          ...
          return (
            <Link key={stat.title} href={stat.link}>
              <div className={`group relative bg-surface-light dark:bg-surface-dark border-2 rounded-2xl p-6 transition-all duration-300 hover:shadow-xl overflow-hidden cursor-pointer ${
                stat.highlight 
                ...
                <div className="relative">
                  ...
                  <p className="text-sm font-medium text-text-light/60 dark:text-text-dark/60 mb-1">{stat.title}</p>
                  <p className="text-3xl font-bold text-text-light dark:text-text-dark">{stat.format(stat.value)}</p>
                </div>
              </div>
            </Link>
          );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-2xl p-6">
          <h2 className="text-xl font-bold text-text-light dark:text-text-dark mb-4">Quick Actions</h2>
          <div className="grid grid-cols-2 gap-4">
            <Link
              href="/membership/applications"
              className="group p-6 bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark rounded-xl hover:border-primary/50 hover:shadow-lg transition-all text-center"
            >
              ...
              <p className="text-sm font-semibold text-text-light dark:text-text-dark">Review Applications</p>
            </Link>
            <Link
              href="/users"
              className="group p-6 bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark rounded-xl hover:border-primary/50 hover:shadow-lg transition-all text-center"
            >
              ...
              <p className="text-sm font-semibold text-text-light dark:text-text-dark">Manage Users</p>
            </Link>
            <Link
              href="/salons"
              className="group p-6 bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark rounded-xl hover:border-primary/50 hover:shadow-lg transition-all text-center"
            >
              ...
              <p className="text-sm font-semibold text-text-light dark:text-text-dark">View All Salons</p>
            </Link>
            <Link
              href="/reports"
              className="group p-6 bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark rounded-xl hover:border-primary/50 hover:shadow-lg transition-all text-center"
            >
              ...
              <p className="text-sm font-semibold text-text-light dark:text-text-dark">View Reports</p>
            </Link>
          </div>
        </div>

        <div className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-2xl p-6">
          <h2 className="text-xl font-bold text-text-light dark:text-text-dark mb-4">Recent Activity</h2>
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-4 bg-background-light dark:bg-background-dark rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-text-light/60 dark:text-text-dark/60">5 minutes ago</p>
              </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-background-light dark:bg-background-dark rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-text-light/60 dark:text-text-dark/60">1 hour ago</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-4 bg-background-light dark:bg-background-dark rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-text-light/60 dark:text-text-dark/60">2 hours ago</p>
              </div>
            </div>
          </div>
        </div>
