            ...
            <div className="flex gap-2">
              {salon.phone && (
                <Button
                  variant="outline"
                  size="lg"
                  className="aspect-square p-0 w-12 flex items-center justify-center rounded-xl bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#25D366] border-[#25D366]/20"
              ...
              {salon.email && (
                <Button
                  ...
                  onClick={() => window.location.href = `mailto:${salon.email}`}
                  title="Email"
                >
