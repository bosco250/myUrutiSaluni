...
import { Search, CheckCircle, XCircle, Clock, Eye, AlertCircle, X, User, Building2, MapPin, Phone, Mail, FileText, Calendar, UserCheck, MessageSquare } from 'lucide-react';
        ...
        <div className="relative overflow-hidden rounded-2xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark p-4">
          ...
          <div className="relative flex items-start justify-between gap-3">
            <div>
              ...
              <p className="text-xl font-black text-warning mt-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-black text-text-light dark:text-text-dark">Review Queue</p>
                <p className="text-xs text-text-light/60 dark:text-text-dark/60 mt-1">
            ...
            {pendingApps.length === 0 ? (
              <div className="rounded-2xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark p-8 text-center">
                <div className="h-10 w-10 rounded-2xl bg-warning/10 text-warning flex items-center justify-center mx-auto mb-3">
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark p-4">
              <p className="text-sm font-black text-text-light dark:text-text-dark">Archive</p>
              <p className="text-xs text-text-light/60 dark:text-text-dark/60 mt-1">
                Approved and rejected applications.
              </p>
              <div className="mt-3 grid grid-cols-2 gap-2">
                <div className="rounded-xl border border-border-light dark:border-border-dark bg-background-light/60 dark:bg-background-dark/40 p-3">
                  <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60">
                    Approved
                  </p>
                  <p className="text-lg font-black text-success mt-1">{approvedApps.length}</p>
                </div>
                <div className="rounded-xl border border-border-light dark:border-border-dark bg-background-light/60 dark:bg-background-dark/40 p-3">
                  <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60">
                    Rejected
                  </p>
                  <p className="text-lg font-black text-danger mt-1">{rejectedApps.length}</p>
                </div>
              </div>
            </div>
...
function ApplicationCard({
  ...
  const statusConfig = {
    pending: { icon: Clock, color: 'text-warning', bg: 'bg-warning/10', border: 'border-warning', rail: 'bg-warning' },
    approved: { icon: CheckCircle, color: 'text-success', bg: 'bg-success/10', border: 'border-success', rail: 'bg-success' },
    rejected: { icon: XCircle, color: 'text-danger', bg: 'bg-danger/10', border: 'border-danger', rail: 'bg-danger' },
  };
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-2xl border ${config.border} bg-surface-light dark:bg-surface-dark hover:shadow-lg transition ${
        compact ? 'p-4' : 'p-5'
      }`}
    >
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                <div className={`h-9 w-9 rounded-2xl ${config.bg} border ${config.border} flex items-center justify-center`}>
            ...
            <span className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${config.bg} ${config.color} ${config.border}`}>
              {application.status}
            </span>
          </div>
            ...
            <div className="p-4">
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3 min-w-0">
                  <div className={`h-11 w-11 rounded-2xl ${config.bg} border ${config.border} flex items-center justify-center flex-shrink-0`}>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <Button
                  ...
                  variant="secondary"
                  size="sm"
                  onClick={() => window.open(`mailto:${application.applicant?.email || application.email}`, '_self')}
                >
                ...
                <Button
                  ...
                  variant="secondary"
                  size="sm"
                  onClick={() => window.open(`tel:${application.applicant?.phone || application.phone}`, '_self')}
                >
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            ...
            <div className="bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark rounded-xl p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-sm font-black text-text-light dark:text-text-dark">Applicant</h3>
                  <p className="text-xs text-text-light/60 dark:text-text-dark/60">Identity and contact</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">Full Name</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">Email</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">Phone</p>
            ...
            <div className="bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark rounded-xl p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-sm font-black text-text-light dark:text-text-dark">Business</h3>
                  <p className="text-xs text-text-light/60 dark:text-text-dark/60">Registration and description</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">Business Name</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">Registration #</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">Tax ID</p>
                ...
                {application.businessDescription && (
                  <div className="md:col-span-2 flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">Description</p>
            ...
            <div className="bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark rounded-xl p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-sm font-black text-text-light dark:text-text-dark">Location</h3>
                  <p className="text-xs text-text-light/60 dark:text-text-dark/60">Address and district</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2 flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">Business Address</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">City</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-light/60 dark:text-text-dark/60 mb-1">District</p>
