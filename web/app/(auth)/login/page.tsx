                ...
                <div className="flex items-center justify-between mb-1">
                  <label 
                    ...
                    className={`block c-secondary font-semibold uppercase tracking-wider transition-colors ${
                      focusedField === 'password' ? 'text-primary' : 'text-text-light/60 dark:text-text-dark/60'
                    }`}
                  >
                    Password
                  </label>
                ...
                <div className={`relative transition-all duration-300 ${
                  ...
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Lock className={`w-4 h-4 transition-colors ${
                      focusedField === 'password' ? 'text-primary' : 'text-text-light/40 dark:text-text-dark/40'
                    }`} />
                  </div>
                  <input
                    id="password"
